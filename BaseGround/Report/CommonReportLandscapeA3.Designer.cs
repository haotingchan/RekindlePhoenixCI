namespace BaseGround.Report {
   partial class CommonReportLandscapeA3 {
      /// <summary>
      ...
      private void InitializeComponent() {
         ...
         this.printableComponentContainerMain.SizeF = new System.Drawing.SizeF(1614F, 33.3333F);
         // 
         // TopMargin
         // 
         ...
         this.PageHeader.HeightF = 46.50403F;
         ...
         // xrTableFooter
         // 
         this.xrTableFooter.LocationFloat = new DevExpress.Utils.PointFloat(388.4418F, 94.54168F);
         ...
         this.lblMemo.Borders = DevExpress.XtraPrinting.BorderSide.None;
         ...
         this.lblMemo.StylePriority.UseBorders = false;
         this.lblMemo.StylePriority.UseFont = false;
         this.lblMemo.StylePriority.UseTextAlignment = false;
         this.lblMemo.TextAlignment = DevExpress.XtraPrinting.TextAlignment.TopLeft;
         ...
         // xrSubreportMain
         // 
         this.xrSubreportMain.LocationFloat = new DevExpress.Utils.PointFloat(388.4418F, 1.712329F);
         ...
         // xrSubreportFooter
         // 
         this.xrSubreportFooter.LocationFloat = new DevExpress.Utils.PointFloat(245.8904F, 9.999993F);
