...
namespace PhoenixCI.BusinessLogic.Prefix3.Tests
{
   ...
   public class B30580Tests
   {
      ...
      public static void MyClassInitialize(TestContext testContext)
      {
         ...
         string excelTemplateDirectoryPath = Path.Combine(Environment.CurrentDirectory.Replace("PhoenixCITests", "PhoenixCI"), "Excel_Template", "30580.xls");
         destinationFilePath = Path.Combine(reportDirectoryPath, "30580_" + DateTime.Now.ToString("yyyy.MM.dd") + "-" + DateTime.Now.ToString("hh.mm.ss") + "Test.xls");
      ...
      public void Setup()
      {
         b30580 = new B30580(destinationFilePath, "2018/12");
      }
      [TestMethod()]
      public void Wf30581Test()
      {
         string msgText = b30580.Wf30581();
