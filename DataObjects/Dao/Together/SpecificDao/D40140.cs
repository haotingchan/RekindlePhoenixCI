...
SELECT 
	...
	CI.MG1.MG1_IM, 
	CI.MG1.MG1_KIND_ID, 
	CI.MGT2.MGT2_ABBR_NAME
FROM CI.MG1,CI.MGT6,CI.MGT2,CI.MG2
WHERE CI.MGT6.MGT6_KIND_ID = CI.MG1.MG1_KIND_ID
AND CI.MG1.MG1_PROD_TYPE = CI.MGT2.MGT2_PROD_TYPE
AND CI.MG1.MG1_KIND_ID = CI.MGT2.MGT2_KIND_ID
AND CI.MG1.MG1_DATE = CI.MG2.MG2_DATE
AND CI.MG1.MG1_KIND_ID = CI.MG2.MG2_KIND_ID
AND MG1_DATE = :isDate
