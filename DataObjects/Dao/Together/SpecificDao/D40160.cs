...
namespace DataObjects.Dao.Together.SpecificDao {
   ...
   /// 40160 期貨原始資料下載
   /// </summary>
   public class D40160 : DataGate {

      /// <summary>
      /// get CI.RPT/CI.APDK (dddw_40160_kind_id) 第一行加入空白
...
";
      ...
      public DataTable ExecuteStoredProcedure(string modelType , string startDate , string endDate , string kindId) {
         ...
         string sql = "CI.SP_H_TXN_40160_DETL";
