...
namespace DataObjects.Dao.Together.SpecificDao
{
   ...
   {
      public DbDataAdapter ListD50030(string is_sum_type, string is_sum_subtype,string is_data_type)
      {
         object[] parms = {
...
";
      ...
      public DbDataAdapter ListACCU(string is_symd,string is_eymd, string is_sum_type, string is_sum_subtype, string is_data_type)
      {
         object[] parms = {
            ":as_symd",is_symd,
            ":as_eymd",is_eymd,
...
";
         DbDataAdapter adapter = db.GetDataAdapter(sql, parms);
         return adapter;
      }//public DbDataAdapter ListD50030Accu
      public DbDataAdapter ListACCUAH(string is_symd, string is_eymd, string is_sum_type, string is_sum_subtype, string is_data_type)
      {
         object[] parms = {
            ":as_symd",is_symd,
            ":as_eymd",is_eymd,
...
";
         DbDataAdapter adapter = db.GetDataAdapter(sql, parms);
         return adapter;
      }//public DbDataAdapter ListD50030AccuAh
      public DbDataAdapter ListAH(string is_sum_type, string is_sum_subtype, string is_data_type)
      {
         object[] parms = {
                ":as_sum_type",is_sum_type,
                ":as_sum_subtype",is_sum_subtype,
...
";
         DbDataAdapter adapter = db.GetDataAdapter(sql, parms);
         return adapter;
      }//public DbDataAdapter ListD50030Ah

      public DataTable dt50030(string is_sum_type, string is_sum_subtype, string is_data_type)
      {
         object[] parms = {
                ":as_sum_type",is_sum_type,
                ":as_sum_subtype",is_sum_subtype,
...
";
         ...
         return dt;
      }//public dt ListD50030
      public DataTable ACCU(string is_symd, string is_eymd, string is_sum_type, string is_sum_subtype, string is_data_type)
      {
         object[] parms = {
            ":as_symd",is_symd,
            ":as_eymd",is_eymd,
...
";
         DataTable dt = db.GetDataTable(sql, parms);
         return dt;
      }//public dt ListD50030Accu
      public DataTable ACCUAH(string is_symd, string is_eymd, string is_sum_type, string is_sum_subtype, string is_data_type)
      {
         object[] parms = {
            ":as_symd",is_symd,
            ":as_eymd",is_eymd,
...
";
         DataTable dt = db.GetDataTable(sql, parms);
         return dt;
      }//public dt ListD50030AccuAh
      public DataTable AH(string is_sum_type, string is_sum_subtype, string is_data_type)
      {
         object[] parms = {
                ":as_sum_type",is_sum_type,
                ":as_sum_subtype",is_sum_subtype,
