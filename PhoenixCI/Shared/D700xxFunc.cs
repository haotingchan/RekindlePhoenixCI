...
namespace PhoenixCI.Shared
{
   public class D700xxFunc
   {
      ...
      public static bool f_70010_week_by_market_code
            ...
            *******************/
            ...
            try {
               foreach (DataRow brkRow in lds_brk.Rows) {
                  ...
                  ls_output1 = ls_output1 + "," + string.Format("{0:#0.00}", brkRow["cp_rate"].AsString());
                  writeFile(is_save_file, ls_output1);
               }
            }
            catch (Exception ex) {
      ...
      private static void writeFile(string openData, string textToAdd)
      {
      ...
      /// <param name="selectEng">選取英文版本</param>
      /// <returns>RETURN:false代表error/true代表成功</returns>
      public static bool f_70010_week_eng_by_market_code(string is_save_file, string is_symd, string is_eymd, string is_sum_type, string is_prod_type, string is_market_code)
      {
         /********************************
         作業:轉70010 週檔 (公司網站\統計資料\週)
         呼叫來源: 70010 (由業務單位手動產生)
      ...
      /// <returns></returns>
      public static bool f_70010_week_his(string is_save_file, string is_symd, string is_eymd, string is_sum_type, string is_prod_type)
      {
         return true;
      }
      /// <summary>
      ...
      /// <param name="is_prod_type"></param>
      /// <returns></returns>
      public static bool f_70010_week_w(string is_save_file, string is_symd, string is_eymd, string is_sum_type, string is_kind_id2, string is_param_key, string is_prod_type)
      {
         /********************************
         作業:轉70010 週檔 (公司網站\統計資料\週)
         呼叫來源: 70010 (由業務單位手動產生)
      ...
      /// <param name="selectEng">選取英文版本</param>
      /// <returns>RETURN:false代表error/true代表成功</returns>
      public static bool f_70010_ymd_by_market_code(string is_save_file, string is_symd, string is_eymd, string is_sum_type, string is_prod_type, string is_market_code, bool selectEng = false)
      {
         /********************************
         作業:轉70010 日,月,年檔 (公司網站\統計資料\日,月,年)
         呼叫來源: 70010 (由業務單位手動產生)
      ...
      /// <param name="selectEng">選取英文版本</param>
      /// <returns>RETURN:false代表error/true代表成功</returns>
      public static bool f_70010_ymd_eng_by_market_code(string is_save_file, string is_symd, string is_eymd, string is_sum_type, string is_prod_type, string is_market_code)
      {
      ...
      /// <param name="is_prod_type"></param>
      /// <returns></returns>
      public static bool f_70010_ymd_his(string is_save_file, string is_symd, string is_eymd, string is_sum_type, string is_prod_type)
      {
         return true;
      }
      /// <summary>
      ...
      /// <param name="is_prod_type"></param>
      /// <returns></returns>
      public static bool f_70010_ymd_org(string is_save_file, string is_symd, string is_eymd, string is_sum_type, string is_prod_type)
      {
         return true;
      }
      /// <summary>
      ...
      /// <param name="is_prod_type"></param>
      public static bool f_70010_ymd_w(string is_save_file, string is_symd, string is_eymd,
