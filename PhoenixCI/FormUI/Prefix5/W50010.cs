...
namespace PhoenixCI.FormUI.Prefix5 {
   public partial class W50010 : FormParent {
      ...
      protected override ResultStatus Retrieve() {
         ...
         string datatype;
         if (radioMarketTime1.Checked) datatype = "O"; //"一般"
         else datatype = "AH";                         //"盤後"
         IGridData50010 gridData = dao50010.CreateGridData(dao50010.GetType() , datatype) as IGridData50010;
         Q50010 q50010 = new Q50010(TxtDate.DateTimeValue , paramKey , kindIdSt , kindIdO , prodSort , fcmSNo , fcmENo , radioPrintSort1.Checked);
         ...
         if (radioPrintSort2.Checked) gvMain.Columns["AMMD_PROD_ID"].VisibleIndex = 0;
         else gvMain.Columns["AMMD_PROD_ID"].VisibleIndex = 4;
         ...
         gvPrint.AppearancePrint.HeaderPanel.Font = new Font("Microsoft YaHei" , 10);
         gvPrint.AppearancePrint.Row.Font = new Font("Microsoft YaHei" , 10);
