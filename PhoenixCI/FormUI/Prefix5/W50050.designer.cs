namespace PhoenixCI.FormUI.Prefix5 {
   partial class W50050 {
      ...
      private void InitializeComponent() {
         ...
         this.AMMD_P_SEQ_NO = new DevExpress.XtraGrid.Columns.GridColumn();
         ...
         this.AMMD_P_SEQ_NO.FieldName = "AMMD_P_SEQ_NO";
         this.AMMD_P_SEQ_NO.Name = "AMMD_P_SEQ_NO";
         this.AMMD_P_SEQ_NO.Visible = true;
         this.AMMD_P_SEQ_NO.VisibleIndex = 6;
         // 
         // AMMD_BUY_PRICE
         // 
      ...
      private DevExpress.XtraGrid.Columns.GridColumn AMMD_P_SEQ_NO;
