...
namespace PhoenixCI.FormUI.Prefix6 {
   ...
   public partial class W60420 : FormParent {
      ...
      protected override ResultStatus Open() {
         ...
         if (!FlagAdmin) {
            grpxTest.Visible = false;
            sleCond1.Visible = false;
            sleCond2.Visible = false;
            sleCond3.Visible = false;
            sleCond41.Visible = false;
            sleCond42.Visible = false;
            sleCond52.Visible = false;
         } else {
            grpxTest.Visible = true;
            sleCond1.Visible = true;
            sleCond2.Visible = true;
            sleCond3.Visible = true;
            sleCond41.Visible = true;
            sleCond42.Visible = true;
            sleCond52.Visible = true;
         }
