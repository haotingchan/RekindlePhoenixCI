...
namespace PhoenixCI.FormUI.Prefix2 {
   ...
   /// 20340 每月網路下單交易量輸入
   /// </summary>
   public partial class W20340 : FormParent {

      private ReportHelper _ReportHelper;
      private AA1 daoAA1;

      public W20340(string programID , string programName) : base(programID , programName) {
         InitializeComponent();
      ...
      protected override ResultStatus Open() {
         base.Open();
         CMC_YM.Caption = "年月";
         CMC_COUNT_G.Caption = "期貨交易量";
         CMC_COUNT_P.Caption = "選擇權交易量";
         CMC_COUNT_B.Caption = "電子下單交易人開戶總數";
