namespace PhoenixCI.FormUI.Prefix3
{
   partial class W30290
   {
      ...
      private void InitializeComponent()
      {
         ...
         this.PLP13_FUT = new DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn();
         this.t2 = new DevExpress.XtraGrid.Views.BandedGrid.GridBand();
         this.PLP13_OPT = new DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn();
         this.t3 = new DevExpress.XtraGrid.Views.BandedGrid.GridBand();
         this.PLP13_KIND_ID2 = new DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn();
         this.SumMonth = new DevExpress.XtraGrid.Views.BandedGrid.GridBand();
         this.t4 = new DevExpress.XtraGrid.Views.BandedGrid.GridBand();
         this.PLP13_NATURE_TOT = new DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn();
         this.t5 = new DevExpress.XtraGrid.Views.BandedGrid.GridBand();
         this.PLP13_LEGAL_TOT = new DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn();
         this.t6 = new DevExpress.XtraGrid.Views.BandedGrid.GridBand();
         this.PLP13_999_TOT = new DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn();
         this.t7 = new DevExpress.XtraGrid.Views.BandedGrid.GridBand();
         this.PLP13_MMK_TOT = new DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn();
         this.SingleMonth = new DevExpress.XtraGrid.Views.BandedGrid.GridBand();
         this.t8 = new DevExpress.XtraGrid.Views.BandedGrid.GridBand();
         this.PLP13_NATURE_MTH = new DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn();
         this.t9 = new DevExpress.XtraGrid.Views.BandedGrid.GridBand();
         this.PLP13_LEGAL_MTH = new DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn();
         this.t10 = new DevExpress.XtraGrid.Views.BandedGrid.GridBand();
         this.PLP13_999_MTH = new DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn();
         this.t11 = new DevExpress.XtraGrid.Views.BandedGrid.GridBand();
         this.PLP13_MMK_MTH = new DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn();
         ...
         this.panParent.Size = new System.Drawing.Size(1197, 657);
         // 
         // ribbonControl
         // 
         ...
         this.gvMain.Columns.AddRange(new DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn[] {
            ...
            this.PLP13_OPT,
            this.PLP13_KIND_ID2,
            this.PLP13_NATURE_TOT,
            this.PLP13_LEGAL_TOT,
            this.PLP13_999_TOT,
            this.PLP13_MMK_TOT,
            this.PLP13_NATURE_MTH,
            this.PLP13_LEGAL_MTH,
            this.PLP13_999_MTH,
            this.PLP13_MMK_MTH,
            this.PLP13_NATURE_LAST,
            this.PLP13_LEGAL_LAST,
            this.PLP13_999_LAST,
            this.PLP13_MMK_LAST,
            this.Is_NewRow});
         ...
         this.t1.AppearanceHeader.TextOptions.VAlignment = DevExpress.Utils.VertAlignment.Bottom;
         this.t1.AppearanceHeader.TextOptions.WordWrap = DevExpress.Utils.WordWrap.Wrap;
         this.t1.Caption = "期貨";
         this.t1.Columns.Add(this.PLP13_FUT);
         this.t1.Name = "t1";
         ...
         this.PLP13_FUT.Name = "PLP13_FUT";
         this.PLP13_FUT.OptionsColumn.ShowCaption = false;
         this.PLP13_FUT.Visible = true;
         this.PLP13_FUT.Width = 60;
         // 
         // t2
         // 
         ...
         this.t2.Caption = "選擇權";
         this.t2.Columns.Add(this.PLP13_OPT);
         this.t2.Name = "t2";
         ...
         this.PLP13_OPT.Name = "PLP13_OPT";
         this.PLP13_OPT.OptionsColumn.ShowCaption = false;
         this.PLP13_OPT.Visible = true;
         this.PLP13_OPT.Width = 60;
         // 
         // t3
         // 
         ...
         this.t3.Caption = " 商品";
         this.t3.Columns.Add(this.PLP13_KIND_ID2);
         this.t3.Name = "t3";
         ...
         this.PLP13_KIND_ID2.Name = "PLP13_KIND_ID2";
         this.PLP13_KIND_ID2.OptionsColumn.ShowCaption = false;
         this.PLP13_KIND_ID2.Visible = true;
         this.PLP13_KIND_ID2.Width = 60;
         // 
         // SumMonth
         // 
         ...
         this.SumMonth.AppearanceHeader.TextOptions.VAlignment = DevExpress.Utils.VertAlignment.Center;
         this.SumMonth.AppearanceHeader.TextOptions.WordWrap = DevExpress.Utils.WordWrap.Wrap;
         this.SumMonth.Caption = "各月份合計";
         this.SumMonth.Children.AddRange(new DevExpress.XtraGrid.Views.BandedGrid.GridBand[] {
            this.t4,
            this.t5,
            this.t6,
            this.t7});
         this.SumMonth.Name = "SumMonth";
         this.SumMonth.VisibleIndex = 1;
         this.SumMonth.Width = 320;
         // 
         // t4
         // 
         ...
         this.t4.AppearanceHeader.TextOptions.VAlignment = DevExpress.Utils.VertAlignment.Center;
         this.t4.AppearanceHeader.TextOptions.WordWrap = DevExpress.Utils.WordWrap.Wrap;
         this.t4.Caption = "自然人";
         this.t4.Columns.Add(this.PLP13_NATURE_TOT);
         this.t4.Name = "t4";
         this.t4.OptionsBand.FixedWidth = true;
         this.t4.VisibleIndex = 0;
         this.t4.Width = 80;
         // 
         // PLP13_NATURE_TOT
         // 
         ...
         this.PLP13_NATURE_TOT.Name = "PLP13_NATURE_TOT";
         this.PLP13_NATURE_TOT.OptionsColumn.ShowCaption = false;
         this.PLP13_NATURE_TOT.Visible = true;
         this.PLP13_NATURE_TOT.Width = 80;
         // 
         // t5
         // 
         ...
         this.t5.AppearanceHeader.TextOptions.VAlignment = DevExpress.Utils.VertAlignment.Center;
         this.t5.AppearanceHeader.TextOptions.WordWrap = DevExpress.Utils.WordWrap.Wrap;
         this.t5.Caption = "法人";
         this.t5.Columns.Add(this.PLP13_LEGAL_TOT);
         this.t5.Name = "t5";
         this.t5.VisibleIndex = 1;
         this.t5.Width = 80;
         // 
         // PLP13_LEGAL_TOT
         // 
         ...
         this.PLP13_LEGAL_TOT.Name = "PLP13_LEGAL_TOT";
         this.PLP13_LEGAL_TOT.OptionsColumn.ShowCaption = false;
         this.PLP13_LEGAL_TOT.Visible = true;
         this.PLP13_LEGAL_TOT.Width = 80;
         // 
         // t6
         // 
         ...
         this.t6.Caption = "自營商";
         this.t6.Columns.Add(this.PLP13_999_TOT);
         this.t6.Name = "t6";
         this.t6.VisibleIndex = 2;
         this.t6.Width = 80;
         // 
         // PLP13_999_TOT
         // 
         ...
         this.PLP13_999_TOT.Name = "PLP13_999_TOT";
         this.PLP13_999_TOT.OptionsColumn.ShowCaption = false;
         this.PLP13_999_TOT.Visible = true;
         this.PLP13_999_TOT.Width = 80;
         // 
         // t7
         // 
         ...
         this.t7.Caption = "造市者";
         this.t7.Columns.Add(this.PLP13_MMK_TOT);
         this.t7.Name = "t7";
         this.t7.VisibleIndex = 3;
         this.t7.Width = 80;
         // 
         // PLP13_MMK_TOT
         // 
         ...
         this.PLP13_MMK_TOT.Name = "PLP13_MMK_TOT";
         this.PLP13_MMK_TOT.OptionsColumn.ShowCaption = false;
         this.PLP13_MMK_TOT.Visible = true;
         this.PLP13_MMK_TOT.Width = 80;
         // 
         // SingleMonth
         // 
         ...
         this.SingleMonth.Caption = "單一月份";
         this.SingleMonth.Children.AddRange(new DevExpress.XtraGrid.Views.BandedGrid.GridBand[] {
            this.t8,
            this.t9,
            this.t10,
            this.t11});
         this.SingleMonth.Name = "SingleMonth";
         this.SingleMonth.VisibleIndex = 2;
         this.SingleMonth.Width = 320;
         // 
         // t8
         // 
         ...
         this.t8.Caption = "自然人";
         this.t8.Columns.Add(this.PLP13_NATURE_MTH);
         this.t8.Name = "t8";
         this.t8.VisibleIndex = 0;
         this.t8.Width = 80;
         // 
         // PLP13_NATURE_MTH
         // 
         ...
         this.PLP13_NATURE_MTH.Name = "PLP13_NATURE_MTH";
         this.PLP13_NATURE_MTH.OptionsColumn.ShowCaption = false;
         this.PLP13_NATURE_MTH.Visible = true;
         this.PLP13_NATURE_MTH.Width = 80;
         // 
         // t9
         // 
         ...
         this.t9.Caption = "法人";
         this.t9.Columns.Add(this.PLP13_LEGAL_MTH);
         this.t9.Name = "t9";
         this.t9.VisibleIndex = 1;
         this.t9.Width = 80;
         // 
         // PLP13_LEGAL_MTH
         // 
         ...
         this.PLP13_LEGAL_MTH.Name = "PLP13_LEGAL_MTH";
         this.PLP13_LEGAL_MTH.OptionsColumn.ShowCaption = false;
         this.PLP13_LEGAL_MTH.Visible = true;
         this.PLP13_LEGAL_MTH.Width = 80;
         // 
         // t10
         // 
         ...
         this.t10.Caption = "自營商";
         this.t10.Columns.Add(this.PLP13_999_MTH);
         this.t10.Name = "t10";
         this.t10.VisibleIndex = 2;
         this.t10.Width = 80;
         // 
         // PLP13_999_MTH
         // 
         ...
         this.PLP13_999_MTH.Name = "PLP13_999_MTH";
         this.PLP13_999_MTH.OptionsColumn.ShowCaption = false;
         this.PLP13_999_MTH.Visible = true;
         this.PLP13_999_MTH.Width = 80;
         // 
         // t11
         // 
         ...
         this.t11.Caption = "造市者";
         this.t11.Columns.Add(this.PLP13_MMK_MTH);
         this.t11.Name = "t11";
         this.t11.VisibleIndex = 3;
         this.t11.Width = 80;
         // 
         // PLP13_MMK_MTH
         // 
         ...
         this.PLP13_MMK_MTH.OptionsColumn.ShowCaption = false;
         this.PLP13_MMK_MTH.Visible = true;
         this.PLP13_MMK_MTH.Width = 80;
         // 
         // NewRow
         // 
      ...
      private DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn PLP13_OPT;
      private DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn PLP13_KIND_ID2;
      private DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn PLP13_NATURE_TOT;
      private DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn PLP13_LEGAL_TOT;
      private DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn PLP13_999_TOT;
      private DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn PLP13_MMK_TOT;
      ...
      private DevExpress.XtraGrid.Views.BandedGrid.GridBand SumMonth;
      ...
      private DevExpress.XtraGrid.Views.BandedGrid.GridBand SingleMonth;
