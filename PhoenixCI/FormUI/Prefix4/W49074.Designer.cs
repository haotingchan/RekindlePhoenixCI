namespace PhoenixCI.FormUI.Prefix4 {
    partial class W49074 {
        ...
        private void InitializeComponent() {
         ...
         this.btnSubDel = new DevExpress.XtraEditors.SimpleButton();
         ...
         this.gcSub.Location = new System.Drawing.Point(0, 0);
         this.gcSub.MainView = this.gvSub;
         this.gcSub.MenuManager = this.ribbonControl;
         this.gcSub.Name = "gcSub";
         this.gcSub.RepositoryItems.AddRange(new DevExpress.XtraEditors.Repository.RepositoryItem[] {
         ...
         this.gvSub.Columns.AddRange(new DevExpress.XtraGrid.Columns.GridColumn[] {
            ...
            this.gridColumn2,
            this.gridColumn3});
         this.gvSub.GridControl = this.gcSub;
         this.gvSub.Name = "gvSub";
         this.gvSub.OptionsView.ColumnAutoWidth = false;
         ...
         this.gridColumn1.Caption = "列";
         this.gridColumn1.FieldName = "RPTF_SEQ_NO";
         ...
         this.gridColumn2.Caption = "文字";
         this.gridColumn2.FieldName = "RPTF_TEXT";
         ...
         // gridColumn3
         // 
         this.gridColumn3.Caption = "Is_NewRow";
         this.gridColumn3.FieldName = "IS_NEWROW";
         ...
         this.gcMain.Size = new System.Drawing.Size(875, 209);
         ...
         this.RPTF_SEQ_NO.Caption = "列";
         this.RPTF_SEQ_NO.FieldName = "RPTF_SEQ_NO";
         this.RPTF_SEQ_NO.Name = "RPTF_SEQ_NO";
         this.RPTF_SEQ_NO.Visible = true;
         this.RPTF_SEQ_NO.VisibleIndex = 0;
         this.RPTF_SEQ_NO.Width = 200;
         // 
         // RPTF_TEXT
         // 
         this.RPTF_TEXT.AppearanceHeader.BackColor = System.Drawing.Color.FromArgb(((int)(((byte)(128)))), ((int)(((byte)(255)))), ((int)(((byte)(255)))));
         this.RPTF_TEXT.AppearanceHeader.Options.UseBackColor = true;
         this.RPTF_TEXT.AppearanceHeader.Options.UseTextOptions = true;
         this.RPTF_TEXT.AppearanceHeader.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Center;
         this.RPTF_TEXT.Caption = "文字";
         this.RPTF_TEXT.FieldName = "RPTF_TEXT";
         this.RPTF_TEXT.Name = "RPTF_TEXT";
         this.RPTF_TEXT.Visible = true;
         this.RPTF_TEXT.VisibleIndex = 1;
         this.RPTF_TEXT.Width = 145;
         // 
         // IS_NEWROW
         // 
      ...
      private DevExpress.XtraEditors.SimpleButton btnSubAdd;
      private DevExpress.XtraEditors.SimpleButton btnSubDel;
