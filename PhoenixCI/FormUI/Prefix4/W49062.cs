        ...
        protected override ResultStatus Export() {
            ...
            try {
                ...
                if (gbItem.EditValue.AsString() == "rbHistory") {
                    ...
                    var result = dt.AsEnumerable().OrderBy(x => { switch (x.Field<string>("mgt8_foreign")) {
                                                                    case "Y": return 1; } return 2; }).
                                                                    ThenBy(x => {switch (x.Field<string>("mgt8_amt_type")) {
                                                                    case "A": return 1; } return 2; }).
                                                                    ThenBy(x => x.Field<string>("f_name")).
