namespace PhoenixCI.FormUI.Prefix4 {
    partial class W40070 {
        ...
        private void InitializeComponent() {
         ...
         this.SMA_MM = new DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn();
         this.SMA_IM = new DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn();
         this.EWMA_MM = new DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn();
         this.EWMA_IM = new DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn();
         this.MAXV_MM = new DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn();
         this.MAXV_IM = new DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn();
         ...
         // panParent
         // 
         this.panParent.Size = new System.Drawing.Size(1393, 820);
         // 
         // ribbonControl
         // 
         this.ribbonControl.ExpandCollapseItem.Id = 0;
         this.ribbonControl.Size = new System.Drawing.Size(1393, 32);
         ...
         this.cbxCodeY.Size = new System.Drawing.Size(61, 25);
         ...
         this.cbxCode.Size = new System.Drawing.Size(61, 25);
         ...
         this.cbxCodeN.Size = new System.Drawing.Size(77, 25);
         ...
         this.lblG2.Location = new System.Drawing.Point(212, 64);
         this.lblG2.Name = "lblG2";
         this.lblG2.Size = new System.Drawing.Size(132, 21);
         ...
         this.txtDateG5.Location = new System.Drawing.Point(348, 61);
         ...
         this.lblG1.Location = new System.Drawing.Point(212, 32);
         this.lblG1.Name = "lblG1";
         this.lblG1.Size = new System.Drawing.Size(132, 21);
         ...
         this.txtDateG1.Location = new System.Drawing.Point(348, 29);
         ...
         this.lblDate.Location = new System.Drawing.Point(15, 32);
         ...
         this.txtSDate.Location = new System.Drawing.Point(95, 29);
         ...
         this.panel2.Size = new System.Drawing.Size(1393, 710);
         ...
         this.gcMain.Size = new System.Drawing.Size(1393, 710);
         ...
         // gvMain
         // 
         this.gvMain.Appearance.BandPanel.BorderColor = System.Drawing.Color.Black;
         this.gvMain.Appearance.BandPanel.Options.UseBorderColor = true;
         this.gvMain.Appearance.BandPanelBackground.BorderColor = System.Drawing.Color.Black;
         ...
         // DATA_YMD
         // 
         this.DATA_YMD.AutoFillDown = true;
         ...
         this.SMA_ADJ_RATE.DisplayFormat.FormatString = "P1";
         ...
         // EWMA_ADJ_RATE
         // 
         this.EWMA_ADJ_RATE.Caption = "EWMA_ADJ_RATE";
         this.EWMA_ADJ_RATE.DisplayFormat.FormatString = "P1";
         ...
         // MAXV_ADJ_RATE
         // 
         this.MAXV_ADJ_RATE.Caption = "MAXV_ADJ_RATE";
         this.MAXV_ADJ_RATE.DisplayFormat.FormatString = "P1";
         ...
         // ADJ_CODE
         // 
         this.ADJ_CODE.AppearanceCell.Options.UseTextOptions = true;
         this.ADJ_CODE.AppearanceCell.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Center;
         this.ADJ_CODE.AutoFillDown = true;
         ...
         // CUR_CM
         // 
         this.CUR_CM.Caption = "CUR_CM";
         this.CUR_CM.FieldName = "CUR_CM";
         this.CUR_CM.Name = "CUR_CM";
         this.CUR_CM.Visible = true;
         // 
         // CUR_MM
         // 
         this.CUR_MM.Caption = "CUR_MM";
         this.CUR_MM.FieldName = "CUR_MM";
         this.CUR_MM.Name = "CUR_MM";
         this.CUR_MM.Visible = true;
         // 
         // CUR_IM
         // 
         this.CUR_IM.AutoFillDown = true;
         this.CUR_IM.Caption = "CUR_IM";
         this.CUR_IM.FieldName = "CUR_IM";
         this.CUR_IM.Name = "CUR_IM";
         this.CUR_IM.Visible = true;
         // 
         // SMA_MM
         // 
         this.SMA_MM.Caption = "SMA_MM";
         this.SMA_MM.FieldName = "SMA_MM";
         this.SMA_MM.Name = "SMA_MM";
         this.SMA_MM.Visible = true;
         // 
         // SMA_IM
         // 
         this.SMA_IM.Caption = "SMA_IM";
         this.SMA_IM.FieldName = "SMA_IM";
         this.SMA_IM.Name = "SMA_IM";
         this.SMA_IM.Visible = true;
         // 
         // EWMA_MM
         // 
         this.EWMA_MM.Caption = "EWMA_MM";
         this.EWMA_MM.FieldName = "EWMA_MM";
         this.EWMA_MM.Name = "EWMA_MM";
         this.EWMA_MM.Visible = true;
         // 
         // EWMA_IM
         // 
         this.EWMA_IM.Caption = "EWMA_IM";
         this.EWMA_IM.FieldName = "EWMA_IM";
         this.EWMA_IM.Name = "EWMA_IM";
         this.EWMA_IM.Visible = true;
         // 
         // MAXV_MM
         // 
         this.MAXV_MM.Caption = "MAXV_MM";
         this.MAXV_MM.FieldName = "MAXV_MM";
         this.MAXV_MM.Name = "MAXV_MM";
         this.MAXV_MM.Visible = true;
         // 
         // MAXV_IM
         // 
         this.MAXV_IM.Caption = "MAXV_IM";
         this.MAXV_IM.FieldName = "MAXV_IM";
         this.MAXV_IM.Name = "MAXV_IM";
         this.MAXV_IM.Visible = true;
         // 
         // PROD_TYPE
         // 
        ...
        private DevExpress.XtraGrid.Views.BandedGrid.AdvBandedGridView gvMain;
        private DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn GRP_NAME;
        ...
        private DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn SMA_ADJ_RATE;
        private DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn SMA_CM;
        private DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn EWMA_ADJ_RATE;
        private DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn EWMA_CM;
        private DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn MAXV_ADJ_RATE;
        private DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn MAXV_CM;
        private DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn USER_CM;
        ...
        private DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn CUR_CM;
        private DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn CUR_MM;
        private DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn CUR_IM;
        private DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn SMA_MM;
        private DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn SMA_IM;
        private DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn EWMA_MM;
        private DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn EWMA_IM;
        private DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn MAXV_MM;
        private DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn MAXV_IM;
