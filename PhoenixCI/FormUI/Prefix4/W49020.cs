...
namespace PhoenixCI.FormUI.Prefix4
{
    ...
    public partial class W49020 : FormParent
    {
        ...
        private RepositoryItemLookUpEdit lupTradekindId; //交易所+商品清單
        ...
        protected override ResultStatus Retrieve()
        {
            ...
            try
            {
                ...
                string[] showColCaption = {"商品", $"對外{Environment.NewLine}商品", $"順{Environment.NewLine}序","商品別",
                                       ...
                                       $"EWMA{Environment.NewLine}調整標準",$"比對國外交易所商品","Is_NewRow"};
                ...
                gvMain.Columns["MGT2_F_ID"].ColumnEdit = lupTradekindId;
                gvMain.Columns["MGT2_F_ID"].ColumnEdit.BestFitWidth = 325;
                gvMain.Columns["MGT2_F_ID"].ShowButtonMode = ShowButtonModeEnum.ShowAlways;
